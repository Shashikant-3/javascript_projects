//to dynamically select categories|
//get only unique categories - (HARDEST ONE)
//itereate over categories return buttons
...
const menu = [
  ...
  },
  {
    ...
    desc: `Portland chicharrones ethical edison bulb, palo santo craft
             beer chia heirloom iPhone everyday`,
  },
  {
    id: 7,
...
window.addEventListener("DOMContentLoaded", function () {
  displayMMenuItems(menu);
  displayMenuButtons();
});

function displayMMenuItems(menuItems) {
  ...
  filterBtns.forEach(function (btn) {
    btn.addEventListener("click", function (e) {
      ...
      if (category === "all") {
        ...
        displayMMenuItems(menuCategory);
      }
    });
  });
}
